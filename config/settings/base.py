...
DATABASES = {
    ...
    default='postgresql://lebclmprod:clmp!0ck3din@leb-clm-prod-flex-14.postgres.database.azure.com:5432/bma_sector_1'),
}
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "users.WebPushToken": "fas fa-bell",
        "mscc.Registration": "fas fa-id-card",
        ...
        "schools.PartnerOrganization": "fas fa-handshake",
        "locations.Center": "fas fa-map-marker-alt",
        "attendances.MSCCAttendance": "fas fa-clipboard-check",
        "backends.ExportHistory": "fas fa-history",
        "backends.UserActivity": "fas fa-user-secret",
    },
}
