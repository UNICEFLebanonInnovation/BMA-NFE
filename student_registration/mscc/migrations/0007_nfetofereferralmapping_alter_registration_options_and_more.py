# Generated by Django 5.2.7 on 2026-03-30 11:27
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("mscc", "0006_analytics_indexes"),
    ]

    operations = [
        migrations.CreateModel(
            name="NFEToFEReferralMapping",
            fields=[
                (
                    "id",
                    models.AutoField(
                ...
                (
                    ...
                    models.CharField(
                        max_length=100,
                        verbose_name="NFE Component Name (e.g. ECE, BLN, ALP)",
                    ),
                ),
                ("min_age", models.IntegerField(default=0, verbose_name="Minimum Age")),
                (
                    "max_age",
                    models.IntegerField(default=99, verbose_name="Maximum Age"),
                ),
            ],
            options={
                "verbose_name": "NFE to FE Referral Mapping",
                "verbose_name_plural": "NFE to FE Referral Mappings",
