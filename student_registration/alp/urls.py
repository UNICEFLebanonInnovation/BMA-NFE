...
urlpatterns = [
    ...
    re_path(r'^registrations/edit/(?P<pk>\d+)/$', view=views.RegistrationEditView.as_view(),
            name='registration_edit'),
    re_path(r'^registrations/delete/(?P<pk>\d+)/$', view=views.RegistrationDeleteView.as_view(),
    ...
    re_path(r'^child-profile/(?P<pk>\d+)/$', view=views.ChildProfileView.as_view(), name='child_profile'),
    ...
    re_path(r'^teachers/edit/(?P<pk>\d+)/$', view=views.TeacherEditView.as_view(), name='teacher_edit'),
    re_path(r'^teachers/delete/(?P<pk>\d+)/$', view=views.TeacherDeleteView.as_view(), name='teacher_delete'),

    re_path(r'^attendance/$', view=attendance_views.AttendanceView.as_view(), name='attendance_list'),
    re_path(r'^load-attendance-children/$', view=attendance_views.LoadAttendanceChildren.as_view(),
            name='load_attendance_children'),
    re_path(r'^save-attendance-children/$', view=attendance_views.save_attendance_children,
            name='save_attendance_children'),

    re_path(r'^teacher-attendance/$', view=attendance_views.TeacherAttendanceView.as_view(),
            name='teacher_attendance_list'),
    re_path(r'^load-attendance-teachers/$', view=attendance_views.LoadAttendanceTeachers.as_view(),
            name='load_attendance_teachers'),
    re_path(r'^save-attendance-teachers/$', view=attendance_views.save_attendance_teachers,
            name='save_attendance_teachers'),

    re_path(r'^grading/add/$', view=views.GradingAddView.as_view(), name='grading_add'),
    re_path(r'^grading/edit/(?P<pk>\d+)/$', view=views.GradingEditView.as_view(), name='grading_edit'),

    re_path(r'^school-profile/$', view=views.SchoolProfileView.as_view(), name='school_profile'),


    re_path(r'^dashboard/registration/$', view=views.ALPRegistrationDashboardView.as_view(),
            name='dashboard_registration'),
    re_path(r'^dashboard/teacher/$', view=views.ALPTeacherDashboardView.as_view(), name='dashboard_teacher'),
    re_path(r'^dashboard/teacher/data/$', view=views.ALPTeacherDashboardDataView.as_view(),
            name='dashboard_teacher_data'),
